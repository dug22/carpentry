...
public interface DateTimeColumnConversions extends ColumnConversion<LocalDateTime> {

    /**
     * Converts a DateTimeColumn to a StringColumn
     *
    ...
    default StringColumn asStringColumn(){
        return convertToColumn(
                ...
                (i) -> isAbsent(i) ? Nulls.getDefaultNullValue(String.class) : getDateTimeColumnFormatter().format(get(i))
        );
    }

    DateTimeColumnFormatter getDateTimeColumnFormatter();
}
