...
public class LongParser implements ColumnParser<Long> {
    ...
    public Long parse(String value) {
        if (isNA(value)) return Nulls.getDefaultNullValue(Long.class);
        String cleanValue = removeComma(value);
        try {
            return Long.parseLong(cleanValue);
        }catch (NumberFormatException e){
            return Nulls.getDefaultNullValue(Long.class);
        }
    }
}
