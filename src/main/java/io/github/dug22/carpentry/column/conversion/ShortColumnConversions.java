...
public interface ShortColumnConversions extends ColumnConversion<Short> {

    /**
     * Converts a ShortColumn to a ByteColumn
     *
     * @return a ByteColumn
     */
    ...
    /**
     * Converts a ShortColumn to a DoubleColumn
     *
    ...
    default DoubleColumn asDoubleColumn() {
        return convertToColumn(
                ...
                (i) -> isAbsent(i) ? Nulls.getDefaultNullValue(Double.class) : get(i).doubleValue());
    }

    /**
     * Converts a ShortColumn to a FloatColumn
     *
    ...
    /**
     * Converts a ShortColumn to an IntegerColumn
     *
    ...
    /**
     * Converts a ShortColumn to a LongColumn
     *
     * @return a LongColumn
     */
    ...
    /**
     * Converts a ShortColumn to a StringColumn
     *
