...
public interface DateColumnConversions extends ColumnConversion<LocalDate> {
    ...
    default StringColumn asStringColumn(){
        return convertToColumn(
                ...
                (i) -> isAbsent(i) ? Nulls.getDefaultNullValue(String.class) : getDateColumnFormatter().format(get(i))
        );
    }

    DateColumnFormatter getDateColumnFormatter();
}
