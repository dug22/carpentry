...
public class RowColumnComparator implements Comparator<DataRow> {
    ...
    public int compare(DataRow r1, DataRow r2) {
        ...
        for (SortColumn sortColumn : sortColumns) {
            ...
            Object value1 = r1.getRowData().get(columnName);
            Object value2 = r2.getRowData().get(columnName);
            ...
            comparisonResult = sortColumn.getDirection() == SortColumn.Direction.ASCENDING ? comparisonResult : -comparisonResult;
    ...
    private int compareValues(Object a, Object b) {
        ...
        return switch (a) {
            ...
            case Number number when b instanceof Number ->
                    Double.compare(number.doubleValue(), ((Number) b).doubleValue());
            default ->
