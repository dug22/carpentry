...
public class IntegerColumnConversionTest {

    private IntegerColumn integerColumn;

    @BeforeEach
    public void setup() {
        integerColumn = IntegerColumn.create("Integers", new Integer[]{1, 2, 3, 4});
    }


    @Test
    public void asByteColumnTest() {
        ByteColumn byteColumn = integerColumn.asByteColumn();
        assertAll(
    ...
    public void asDoubleColumnTest() {
        DoubleColumn doubleColumn = integerColumn.asDoubleColumn();
        assertAll(
    ...
    public void asLongColumnTest() {
        LongColumn longColumn = integerColumn.asLongColumn();
        assertAll(
    ...
    public void asShortColumnTest() {
        ShortColumn shortColumn = integerColumn.asShortColumn();
        assertAll(
    ...
    public void asStringColumn() {
        StringColumn stringColumn = integerColumn.asStringColumn();
        assertAll(
